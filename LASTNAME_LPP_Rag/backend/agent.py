...
class RAGAgent:
    ...
    def ask(self, question: str) -> dict:
        ...
        agent = Agent(
            role= "Friends Life & Relationships Insight Assistant",
            goal= "Answer any questions about the show Friends.",
            backstory= "You are an insightful assistant with access to a curated collection of analyses, essays, and commentaries about the TV show Friends. " \
            "You use this material to explain why the show feels relatable, emotionally meaningful, and enduring to audiences.",
            tools=[query_tool],
            llm=llm,
        ...
        task = Task(description = question, 
                    agent = agent,
                    expected_output = "A thoughtful, well-structured response grounded in the retrieved documents that explains how Friends mirrors real-life experiences, relationships, or emotions.")
